...
## <span style="color:blue;">Fun Fact</span>
...
### <span style="color:red;">Commentary</span>
...
::: {.callout-important}
We want variables to correlate however we do not want them to correlate either <br> too low (**r** $<$ .30) or too high (**r** $>$ .80) across multiple items*
:::

## CFA Assumptions (Fields et al, 2012)
