...
| Static Figures (e.g., line/bar graphs) |      \$20\*\*       |
...
::: callout-important
## Note
\*\*These are the base prices for each individual reporting type. Price will be adjusted to account for visualization complexity.

^1^ Please note these reports can break if data entry methods (i.e., the source data) change. Repairing this break would require a new fee to fix and is not included in the original project price.
:::
